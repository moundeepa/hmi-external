import { SimpleComponent } from './components/Simple--external/Simple--external.component';
...
@NgModule({
    declarations: [PasswordExternalComponent,
        ...
        StackblitzEditorComponent, SimpleComponent],
    ...
    exports: [PasswordExternalComponent,
        ...
        GenerateWithAiComponent, SimpleComponent],
    providers: [
        DialogService,
        providePrimeNG({ 
            theme: {
